 /* note :- the live eg of iterator is pagination.
 iterator is one type of collections, it define the sequence   */
 
 
 //create the function
 function Iterator(profile)
 {
     /*  set the index to 0 , yaha done:false means  update ho jayega
     & nextIndex ki profile show hogi , ager last profile hoga to
     done:true so age nextIndex ayegi h nahi */ 
     let nextIndex = 0;
